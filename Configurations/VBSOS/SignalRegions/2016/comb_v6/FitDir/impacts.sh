...
combineTool.py -M Impacts -d ${workspaceDir}/combine_${var}.root -m 125 -t -1 --setParameters r_vbs=1 --redefineSignalPOIs=r_vbs --X-rtd MINIMIZER_analytic -o ${workspaceDir}/impacts_2016_${var}.json 

cd $workspaceDir

plotImpacts.py -i impacts_2016_${var}.json -o impacts_2016_${var}
