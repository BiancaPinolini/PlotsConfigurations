...
#ifndef MVAReader_emtight_v6_H
#define MVAReader_emtight_v6_H

class MVAReader_emtight_v6 : public multidraw::TTreeFunction {
public:
  
  MVAReader_emtight_v6(const char* model_path, bool verbose, int cut);

  char const* getName() const override { return "MVAReader_emtight_v6"; }
  TTreeFunction* clone() const override { return new MVAReader_emtight_v6(model_path_.c_str(), verbose, cut_); }
...
MVAReader_emtight_v6::MVAReader_emtight_v6(const char* model_path, bool verbose, int cut):
...
double 
MVAReader_emtight_v6::evaluate(unsigned)
{
  // Run only if 
...
void
MVAReader_emtight_v6::bindTree_(multidraw::FunctionLibrary& _library)
{  
