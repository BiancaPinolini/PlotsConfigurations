...
#ifndef MVAReader_emmedium_v1_H
#define MVAReader_emmedium_v1_H

class MVAReader_emmedium_v1 : public multidraw::TTreeFunction {
public:
  
  MVAReader_emmedium_v1(const char* model_path, bool verbose, int cut);

  char const* getName() const override { return "MVAReader_emmedium_v1"; }
  TTreeFunction* clone() const override { return new MVAReader_emmedium_v1(model_path_.c_str(), verbose, cut_); }
...
MVAReader_emmedium_v1::MVAReader_emmedium_v1(const char* model_path, bool verbose, int cut):
...
double
MVAReader_emmedium_v1::evaluate(unsigned)
{
  // Run only if 
...
void
MVAReader_emmedium_v1::bindTree_(multidraw::FunctionLibrary& _library)
{  
