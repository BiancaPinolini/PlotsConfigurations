...
date=210103
workDir=/afs/cern.ch/user/b/bpinolin/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/VBSOS/SignalRegions/2018/comb_v6/datacards
var=DNNoutput_20
...
plotImpacts.py -i impacts_2018_${var}.json -o impacts_2018_${var}
